...
function App(){
  const dataPersonas = [
  {id: 1 , nombre: "Cristian" , descripcion : "cantante"},
  {id: 2 , nombre: "Andres" , descripcion : "futbolista"},
  {id: 3 , nombre: "Felipe" , descripcion : "albañil"},
  {id: 4 , nombre: "Lorena" , descripcion : "modelo"},
  {id: 5 , nombre: "Cristina" , descripcion : "auditora"},
  {id: 6 , nombre: "Romina" , descripcion : "secretaria"},
  {id: 7 , nombre: "Carlos" , descripcion : "programador"},
  {id: 8 , nombre: "Esteban" , descripcion : "limpiador"},
  {id: 9 , nombre: "Robin" , descripcion : "cargador"},
  {id: 10 , nombre: "Sara" , descripcion : "cocinero"},
];
...
return(
  <div className="App">
        ...
        <tbody>
          {data.map(elemento=>(
            <tr>
              ...
              <td> 
              <button className='btn btn-primary' onClick={()=> seleccionarPersona(elemento, "Editar")}>Editar</button> {""} 
              <button className='btn btn-danger' onClick={()=> seleccionarPersona(elemento, "Eliminar")}>Eliminar</button>
              </td>
            </tr>
            ))}
        </tbody>
    ...
    <Modal isOpen={modalEliminar}>
      <ModalBody>
      Estas seguro que deseas eliminar a la persona {personaSeleccionada && personaSeleccionada.nombre}
      </ModalBody>
      <ModalFooter>
